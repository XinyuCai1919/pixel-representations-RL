...
class DistractingViT(nn.Module):
    r""" Distracting Vision Transformer
    ...
    def __init__(self,
                 ...
                 depths=[6, 3, 3],
                 num_heads=[6, 6, 6],
                 num_group_tokens=[8, 4, 2],
                 num_output_groups=[8, 4, 2],
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer < self.num_layers:
                out_dim = embed_dim * embed_factors[i_layer]
...
def dis_vit_small_patch6_h3d6(**kwargs):
    model = DistractingViT(
        patch_size=6, embed_dim=192, depths=[2, 2, 2], num_heads=[3, 3, 3],
