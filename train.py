            ...
            while not done:
                ...
                with utils.eval_mode(agent):
                    if sample_stochastically:
                        ...
                        action = agent.select_action(obs / 255., mask_ratio=args.mask_ratio)
...
def main():
    ...
    + str(args.batch_size) + '-s' + str(args.seed) + '-' + args.encoder_type + '-' + args.data_augs  + '-' + str(args.mask_ratio) + '-' + 'token'
