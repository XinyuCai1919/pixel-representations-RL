...
class PixelSacAgent(BaseSacAgent):
    ...
    def __init__(
        ...
        print('########################################################################')
        print('################### Starting Case 1: Baseline Agent ####################')
        print('##################### Reward: Yes; Transition: Yes #####################')
        print('###################### Reward through Transition #######################')
        print('########################################################################')
    ...
    def update(self, replay_buffer, L, step):
        if self.encoder_type == 'pixel':
            ...
            transition_loss, reward_loss = self.update_transition_model(input_encoded_obs, batch_action,
                                                                        target_encoded_obs, target_rewards)
